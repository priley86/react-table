(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "react", "../../@patternfly/patternfly/components/Table/table.css.js", "../../@patternfly/patternfly/components/Table/table-grid.css.js", "./base", "@patternfly/react-core", "@patternfly/react-styles", "prop-types", "./SortColumn", "./BodyCell", "./HeaderCell", "./RowWrapper", "./BodyWrapper", "./utils/headerUtils"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("react"), require("../../@patternfly/patternfly/components/Table/table.css.js"), require("../../@patternfly/patternfly/components/Table/table-grid.css.js"), require("./base"), require("@patternfly/react-core"), require("@patternfly/react-styles"), require("prop-types"), require("./SortColumn"), require("./BodyCell"), require("./HeaderCell"), require("./RowWrapper"), require("./BodyWrapper"), require("./utils/headerUtils"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.tableCss, global.tableGridCss, global.base, global.reactCore, global.reactStyles, global.propTypes, global.SortColumn, global.BodyCell, global.HeaderCell, global.RowWrapper, global.BodyWrapper, global.headerUtils);
    global.Table = mod.exports;
  }
})(this, function (exports, _react, _tableCss, _tableGridCss, _base, _reactCore, _reactStyles, _propTypes, _SortColumn, _BodyCell, _HeaderCell, _RowWrapper, _BodyWrapper, _headerUtils) {
  "use strict";
