(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './ActionsColumn', './Table', './Header', './Body', './BodyWrapper', './RowWrapper', './ExpandableRowContent', './utils', './SortColumn'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./ActionsColumn'), require('./Table'), require('./Header'), require('./Body'), require('./BodyWrapper'), require('./RowWrapper'), require('./ExpandableRowContent'), require('./utils'), require('./SortColumn'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.ActionsColumn, global.Table, global.Header, global.Body, global.BodyWrapper, global.RowWrapper, global.ExpandableRowContent, global.utils, global.SortColumn);
    global.index = mod.exports;
  }
})(this, function (exports, _ActionsColumn, _Table, _Header, _Body, _BodyWrapper, _RowWrapper, _ExpandableRowContent, _utils, _SortColumn) {
  'use strict';
