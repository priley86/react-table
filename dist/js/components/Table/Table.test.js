...
describe('Simple table', function () {
  test('caption', function () {
    var view = (0, _enzyme.mount)(_react["default"].createElement(_index.Table, {
      caption: "Simple Table",
      cells: _dataSets.columns,
      rows: _dataSets.rows
    }, _react["default"].createElement(_index.TableHeader, null), _react["default"].createElement(_index.TableBody, null)));
    expect(view).toMatchSnapshot();
  });
  test('header', function () {
    var view = (0, _enzyme.mount)(_react["default"].createElement(_index.Table, {
      header: _react["default"].createElement("h4", null, "Header title"),
      cells: _dataSets.columns,
      rows: _dataSets.rows
    }, _react["default"].createElement(_index.TableHeader, null), _react["default"].createElement(_index.TableBody, null)));
    expect(view).toMatchSnapshot();
...
test('Selectable table with selected expandable row', function () {
  ...
  var view = (0, _enzyme.mount)(_react["default"].createElement(_index.Table, _extends({
    "aria-label": "Aria labeled"
  }, data), _react["default"].createElement(_index.TableHeader, null), _react["default"].createElement(_index.TableBody, null)));
